  ...
  <Document>
    <Page size="LETTER" style={styles.page}>
      ...
      <View style={styles.header}>
        <Text style={styles.schoolName}>{schoolName || 'ScholarPath Staff Evaluation'}</Text>
      ...
      <Text style={styles.footer}>
        Generated by ScholarPath Staff Evaluation • {new Date().toLocaleDateString()} • ScholarPath Systems
      </Text>
    </Page>
  </Document>
)
