...
function LeaveTracker() {
  ...
  // Derived values for qualifying fields
                    ...
                    {stateFederal.length > 0 && (
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {stateFederal.map(b => {
                            const entries = getStaffEntries(s.id).filter(e => e.leave_type_id === b.type.id)
                ...
                <tbody className="divide-y divide-gray-100">
                  {leaveEntries.map(entry => (
                    <tr key={entry.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-[#2c3e7e] font-medium">
                      ...
                      <td className="px-4 py-3 text-xs text-[#666666]">
                        ...
                        {entry.qualifying_relationship && (
                          <div className="text-gray-400">{entry.qualifying_relationship.replace(/_/g, ' ')}{entry.relationship_name ? ` — ${entry.relationship_name}` : ''}</div>
                        )}
                      </td>
                ...
                {isProtectedLeave && (
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 space-y-3">
                    ...
                    <div>
                      ...
                      <select
                        value={newEntry.qualifying_reason}
                    ...
                    <div>
                      ...
                      <select
                        value={newEntry.qualifying_relationship}
                        onChange={e => setNewEntry(p => ({
                          ...p,
                          qualifying_relationship: e.target.value,
                    ...
                    {newEntry.qualifying_relationship && !isSelfRelationship && (
                      <div>
                        ...
                        <input
                          type="text"
                          value={newEntry.relationship_name}
