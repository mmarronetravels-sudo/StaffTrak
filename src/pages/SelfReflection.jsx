        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="flex gap-4">
              ...
              <a href="/self-reflection" className="text-white hover:text-gray-200 font-semibold">Self-Reflection</a>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={handleLogout} className="bg-white text-[#2c3e7e] px-4 py-2 rounded-lg hover:bg-gray-100">
              Logout
            </button>
          </div>
        </div>
