        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="flex gap-4">
              ...
              <a href="/my-meetings" className="text-white hover:text-gray-200">My Meetings</a>
              <a href="/my-summative" className="text-white hover:text-gray-200 font-semibold">My Evaluation</a>
            </div>
          </div>
